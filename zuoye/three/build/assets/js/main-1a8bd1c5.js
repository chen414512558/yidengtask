...
/******/ 	var hotCurrentHash = "1a8bd1c544cc2e98da94"; // eslint-disable-line no-unused-vars
...
var get_prototype_of = __webpack_require__(54);
var get_prototype_of_default = /*#__PURE__*/__webpack_require__.n(get_prototype_of);

// EXTERNAL MODULE: ./node_modules/babel-runtime/helpers/possibleConstructorReturn.js
var possibleConstructorReturn = __webpack_require__(58);
...
var regenerator = __webpack_require__(88);
...
var classCallCheck = __webpack_require__(107);
var classCallCheck_default = /*#__PURE__*/__webpack_require__.n(classCallCheck);

// EXTERNAL MODULE: ./node_modules/babel-runtime/helpers/createClass.js
var createClass = __webpack_require__(108);
var createClass_default = /*#__PURE__*/__webpack_require__.n(createClass);

// CONCATENATED MODULE: ./zuoye/three/src/webapp/libs/myfunc.js
...
function fetchClick(funcAjax) {
    ...
    return function () {
        if (isClick) {
            ...
            return funcAjax.apply(this, args).then(function (data) {
                isClick = true;
                return data;
            }).catch(function (e) {
                console.log('错误：', e);
...
var external__jQuery_ = __webpack_require__(112);
var external__jQuery__default = /*#__PURE__*/__webpack_require__.n(external__jQuery_);

// CONCATENATED MODULE: ./zuoye/three/src/webapp/assets/js/thumb.js
...
var thumb_ParasiseButton = function () {
    function ParasiseButton(panelSelector, clickSelector) {
        classCallCheck_default()(this, ParasiseButton);

        this.thumbUpNum = 0;
        this.$panel = external__jQuery__default()(panelSelector);
        this.$clickDom = external__jQuery__default()(clickSelector);
    }

    createClass_default()(ParasiseButton, [{
        key: 'init',
        value: function init() {
            var _this = this;

            // 随便点击
            this.$clickDom.on('click', asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
                var waitClick, json, currentNum;
                return regenerator_default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _this.thumbUpNum = add(_this.thumbUpNum);
                                waitClick = fetchClick(function () {
                                    return external__jQuery__default.a.ajax({
                                        url: '/thumb/add',
                                        type: 'POST',
                                        dataType: 'json',
                                        data: {}
        ...
        value: function renderAddOneDom() {
            var addOneDom = external__jQuery__default()('<div class="addOneDom addOneAnimation">+1</div>');
            return addOneDom;
        }
    }, {
        key: 'resetNum',
...
var thumb_Thumb = function (_ParasiseButton) {
    inherits_default()(Thumb, _ParasiseButton);

    function Thumb(panelId, clickId) {
        classCallCheck_default()(this, Thumb);

        return possibleConstructorReturn_default()(this, (Thumb.__proto__ || get_prototype_of_default()(Thumb)).call(this, panelId, clickId));
    }

    return Thumb;
}(thumb_ParasiseButton);

/* harmony default export */ var js_thumb = (thumb_Thumb);
;
// EXTERNAL MODULE: ./zuoye/three/src/webapp/assets/css/thumbsup.css
var thumbsup = __webpack_require__(113);
var thumbsup_default = /*#__PURE__*/__webpack_require__.n(thumbsup);

// EXTERNAL MODULE: ./node_modules/x-tag/src/core.js
var core = __webpack_require__(114);
var core_default = /*#__PURE__*/__webpack_require__.n(core);

// CONCATENATED MODULE: ./zuoye/three/src/webapp/assets/js/main.js



core_default.a.register('x-praise', {
    ...
    lifecycle: {
        created: function created() {
            var thumb = new js_thumb('.thumbsUp', '.thumbsUp');
            thumb.init();
        }
    }
});
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(11)(Function.call, __webpack_require__(46).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
/*** X-Tag Object Definition ***/
  ...
  if (true) !(__WEBPACK_AMD_DEFINE_FACTORY__ = (xtag),
